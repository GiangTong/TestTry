...
namespace fa.todo.presentation.Controllers
{
    public class TodoesController : Controller
    {
        ...
        {
            var todoContext = _context.Todos.Include(t => t.Category);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,IsCompleted,CreatedDate,ModifiedDate,CategoryId")] Todo todo)
        {
